...
def getINTMMatrix(bsize, rng, igeon_pose):
	...
	fix_center_to_origin = T.set_subtensor(fix_center_to_origin[:,0,2], T.constant(-0.5))
	fix_center_to_origin = T.set_subtensor(fix_center_to_origin[:,1,1], T.constant(1.0))
	fix_center_to_origin = T.set_subtensor(fix_center_to_origin[:,1,2], T.constant(-0.5))
